...
- [#16600](https://dev.ckeditor.com/ticket/16600): [Blink, WebKit] Fixed: Error thrown flexiblely by an uninitialized editable for multiple CKEditor instances on the same page.
