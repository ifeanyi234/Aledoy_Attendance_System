...
$query_ed = "select * from job_post where token = '" . $_GET['token'] . "'";
                                ...
                                <form action="editJob" method="post" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="img-text col-md-6">
                                            <label>Title</label>
                                            <input type="text" name="title" class="form-control" value="<?php echo $row['job_title']; ?>">
                                            <br>
                                        </div>
                                        ...
                                        <div class="img-text col-md-6">
                                            ...
                                            <input type="text" name="job_type" class="form-control" value="<?php echo $row['job_type']; ?>">
                                            <br>
                                        </div>
                                        ...
                                        <div class="img-text col-md-6">
                                            ...
                                            <input type="date" name="deadline" class="form-control" value="<?php echo $row['deadline']; ?>">
                                            <br>
                                        </div>

                                          <div class="img-text col-md-6">
                                            <label>Job Url</label>
                                            <input type="text" name="job_url" class="form-control" value="<?php echo $row['job_url']; ?>" >
                                            <br>
                                        </div>   

                                        <div class="img-text  col-md-6">
                                            <label>Qualification</label>
                                            <textarea name="qualification" rows="4" class="form-control" cols="50" placeholder="Enter your message here"><?php echo $row['qualification']; ?></textarea>
                                            <script>
                                        ...
                                        <div class="img-text  col-md-6">
                                            ...
                                            <textarea name="experience" rows="4" class="form-control" cols="50" placeholder="Enter your message here"><?php echo $row['experience']; ?></textarea>
                                            <script>
                                        ...
                                        <div class="img-text  col-md-6">
                                            ...
                                            <textarea name="description" rows="4" class="form-control" cols="50" placeholder="Enter your message here"><?php echo $row['description']; ?></textarea>
                                            <script>
                                        ...
                                        <div class="img-text  col-md-6">
                                            <label>Skills</label>
                                            <textarea name="skills" rows="4" class="form-control" cols="50" placeholder="Enter your message here"><?php echo $row['skills']; ?></textarea>
                                            <script>
                                        ...
                                        <div class="img-text  col-md-12">
                                            ...
                                            <textarea name="responsibilities" rows="4" class="form-control" cols="50" placeholder="Enter your message here"><?php echo $row['responsibilities']; ?></textarea>
                                            <script>
                                        ...
                                        <div class="img-text" style="margin-top: 40px;">
                                            ...
                                            <input class="btn btn-success" style=" margin-bottom: 10px;" type="submit" value="Edit Job">
                                        </div><br>
                                    </div>
                                </form>
                            </div>
